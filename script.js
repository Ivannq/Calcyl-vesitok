...
let typeColor = {
    ...
    "Односторонняя чёрно-белая": { print: 15, file: 110 },
    "Двусторонняя чёрно-белая": { print: 28, file: 220 },
    "Односторонняя цветная": { print: 36, file: 110 },
    "Цветная с лицевой, ч/б с оборотной": { print: 52, file: 220 },
